  ...
  return (
    <div className="fixed inset-0 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        {/* Corner accents */}
        <div className="absolute top-0 left-0 w-[600px] h-[600px] bg-gradient-to-br from-red-600/20 to-transparent rounded-full blur-3xl" />
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-gradient-to-bl from-amber-600/20 to-transparent rounded-full blur-3xl" />
        <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-gradient-to-tr from-yellow-600/20 to-transparent rounded-full blur-3xl" />
        <div className="absolute bottom-0 right-0 w-[600px] h-[600px] bg-gradient-to-tl from-red-600/20 to-transparent rounded-full blur-3xl" />
